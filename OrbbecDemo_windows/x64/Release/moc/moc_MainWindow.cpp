...
QT_MOC_LITERAL(1, 11, 12), // "windowShowed"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 4), // "flag"
QT_MOC_LITERAL(4, 30, 3) // "dir"

    },
    "OrbbecDemo\0windowShowed\0\0flag\0dir"
};
...
void OrbbecDemo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->windowShowed((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OrbbecDemo::windowShowed)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void OrbbecDemo::windowShowed(bool _t1, QString _t2)
{
